...
import { HistoriaClinicaConsulta, FiltroHistoria } from '../historia-clinica/historia-clinica';
...
import { DialogHistoriaClinica } from '../historia-clinica/historia-clinica.component';
...
export class ConsultasComponent implements AfterViewInit, OnDestroy {
  ...
  crearConsulta(item: CitaAdmin) {
    ...
    let filtroHistoria: FiltroHistoria = {
      "fechaDesde": "2019-03-09",
      "fechaHasta": "2023-03-09",
