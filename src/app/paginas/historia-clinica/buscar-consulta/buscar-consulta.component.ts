...
import { Consulta, Evolucion } from '../consultas/consulta';
...
import { DialogDescargaFisioterapeutico } from '../consultas/consultas.component';
...
export class BuscarConsultaComponent implements OnInit {
  ...
  abrirDescargaEvulucion(element: Consulta){
    const dialogRe = this.dialog.open(DialogDescargaEvolucionComponent,{
      width: '1400px',
      data: element
    })
  }
